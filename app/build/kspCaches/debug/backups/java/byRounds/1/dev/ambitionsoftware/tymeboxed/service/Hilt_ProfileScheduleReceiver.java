...
public abstract class Hilt_ProfileScheduleReceiver extends BroadcastReceiver {
  ...
  protected void inject(Context context) {
    if (!injected) {
      synchronized (injectedLock) {
        if (!injected) {
          ((ProfileScheduleReceiver_GeneratedInjector) BroadcastReceiverComponentManager.generatedComponent(context)).injectProfileScheduleReceiver(UnsafeCasts.<ProfileScheduleReceiver>unsafeCast(this));
          injected = true;
        }
      }
    }
