...
public final class ProfileEditViewModel_Factory implements Factory<ProfileEditViewModel> {
  ...
  public ProfileEditViewModel_Factory(Provider<SavedStateHandle> savedStateHandleProvider,
      ...
      Provider<SessionRepository> sessionRepositoryProvider, Provider<Context> appContextProvider) {
  ...
  public ProfileEditViewModel get() {
    return newInstance(savedStateHandleProvider.get(), profileRepositoryProvider.get(), sessionRepositoryProvider.get(), appContextProvider.get());
  }
  ...
  public static ProfileEditViewModel_Factory create(
      ...
      Provider<ProfileRepository> profileRepositoryProvider,
      Provider<SessionRepository> sessionRepositoryProvider, Provider<Context> appContextProvider) {
    return new ProfileEditViewModel_Factory(savedStateHandleProvider, profileRepositoryProvider, sessionRepositoryProvider, appContextProvider);
  }

  public static ProfileEditViewModel newInstance(SavedStateHandle savedStateHandle,
      ProfileRepository profileRepository, SessionRepository sessionRepository,
      Context appContext) {
    return new ProfileEditViewModel(savedStateHandle, profileRepository, sessionRepository, appContext);
  }
}
