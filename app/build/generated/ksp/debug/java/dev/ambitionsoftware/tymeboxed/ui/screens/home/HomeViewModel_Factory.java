...
public final class HomeViewModel_Factory implements Factory<HomeViewModel> {
  ...
  public HomeViewModel get() {
    return newInstance(profileRepositoryProvider.get(), sessionRepositoryProvider.get(), appContextProvider.get());
  }

  public static HomeViewModel_Factory create(Provider<ProfileRepository> profileRepositoryProvider,
      Provider<SessionRepository> sessionRepositoryProvider, Provider<Context> appContextProvider) {
    return new HomeViewModel_Factory(profileRepositoryProvider, sessionRepositoryProvider, appContextProvider);
  }

  public static HomeViewModel newInstance(ProfileRepository profileRepository,
      SessionRepository sessionRepository, Context appContext) {
    return new HomeViewModel(profileRepository, sessionRepository, appContext);
  }
}
